...
class Solution {
    private HashMap<String, Boolean> mem = new HashMap<String, Boolean>();
    public boolean isScramble(String s1, String s2) {
        ...
        if (n==3)
        {
            if(s1.equals("" + s2.charAt(1)  + s2.charAt(0) + s2.charAt(2)))
                ...
                return true;
            else if (s1.equals("" + s2.charAt(0)  + s2.charAt(2) + s2.charAt(1)))
                return true;
            else if (s1.equals("" + s2.charAt(1)  + s2.charAt(2) + s2.charAt(0)))
                return true;
            return false;
        }
